...
export interface Settings { endpoint: string; model: string; language: LanguagePreference; promptMode: PromptMode; prompt: string; maxSize: number; lowConfidenceThreshold: number; highConfidenceThreshold: number; }
